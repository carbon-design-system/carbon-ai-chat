...
Write it like the docs: follow [tone.md](tone.md), including the grade 9 reading level. A description should read like a note to a busy teammate, not a technical manual.
...
- Check the reading level before handing back: `npm run reading-level -- PR.md`. If it reads above grade 9, split long sentences and cut clauses.
