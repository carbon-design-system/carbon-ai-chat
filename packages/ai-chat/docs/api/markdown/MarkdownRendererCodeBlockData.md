...
- Kind: TypeAlias
- Category: Messaging
- Reference: https://chat.carbondesignsystem.com/version/v1.19.0-rc.1/docs/types/Type_reference.MarkdownRendererCodeBlockData.html
...
```ts
type MarkdownRendererCodeBlockData = _MarkdownRendererCodeBlockData
```
