...
- Kind: TypeAlias
- Category: Messaging
- Reference: https://chat.carbondesignsystem.com/version/v1.19.0-rc.1/docs/types/Type_reference.MarkdownRendererTableData.html
...
```ts
type MarkdownRendererTableData = _MarkdownRendererTableData
```
