...
- Kind: TypeAlias
- Category: Instance
- Reference: https://chat.carbondesignsystem.com/version/v1.18.0/docs/types/Type_reference.CustomPanelOpenOptions.html
...
- [CustomPanelConfigOptions](./CustomPanelConfigOptions.md)
- [CustomPanelInstance.open](./CustomPanelInstance.md)
