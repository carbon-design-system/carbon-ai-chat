...
- Kind: TypeAlias
- Category: Messaging
- Reference: https://chat.carbondesignsystem.com/version/v1.19.0-rc.1/docs/types/Type_reference.MarkdownRendererLinkArgs.html
...
```ts
type MarkdownRendererLinkArgs = _MarkdownRendererLinkArgs
```
