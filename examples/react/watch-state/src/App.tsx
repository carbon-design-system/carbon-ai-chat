 ...
 * `homeScreenState.isHomeScreenOpen` and reflects it in a small status panel
 * above the chat.
 *
 * APIs exercised:
...
const config: PublicConfig = {
  ...
  // Auto-open so the homescreen is visible immediately and the state listener has something to mirror.
