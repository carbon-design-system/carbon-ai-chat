...
| [Mentions & Commands](./mentions-and-commands/)                               | Demonstrates `@mentions` and `/commands` with structured data integration via `onSelect` and `updateStructuredData`.                                        | `npm run start --workspace=@carbon/ai-chat-examples-react-mentions-and-commands`                                               |
| [Mentions & Commands (Custom Render)](./mentions-and-commands-custom-render/) | Demonstrates custom token rendering for `@mentions` using Carbon Tag + Tooltip, with default chips for `/commands`.                                         | `npm run start --workspace=@carbon/ai-chat-examples-react-mentions-and-commands-custom-render`                                 |
| [Typeahead](./typeahead/)                                                     | Demonstrates typeahead/autocomplete suggestions that appear as the user types.                                                                              | `npm run start --workspace=@carbon/ai-chat-examples-react-typeahead`                                                           |
| [Typeahead (Custom List)](./typeahead-custom/)                                | Demonstrates a custom autocomplete list component via `renderCustomList`, replacing the built-in dropdown.                                                  | `npm run start --workspace=@carbon/ai-chat-examples-react-typeahead-custom`                                                    |
