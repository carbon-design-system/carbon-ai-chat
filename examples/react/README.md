...
| [Chat History (Float)](./chat-history-float/)                               | Example using the chat history feature with the float layout.                                                                                               | `npm run start --workspace=@carbon/ai-chat-examples-react-chat-history-float`                                                  |
| [Chat History (Fullscreen)](./chat-history-fullscreen/)                     | Example using the chat history feature with the fullscreen layout.                                                                                          | `npm run start --workspace=@carbon/ai-chat-examples-react-chat-history-fullscreen`                                             |
...
| [React 17](./react-17/)                                                     | Example embedding the chat as a React component in a React 17 application.                                                                                  | `npm run start --workspace=@carbon/ai-chat-examples-react-17`                                                                  |
