        ...
        suggestions: [
          {
            ...
            // `autoAlign` forwards to the internal Popover which uses
            // floating-ui with `strategy: 'fixed'` — positions relative
            // to the viewport so the popup escapes the editor's scroll
            // overflow clipping.
