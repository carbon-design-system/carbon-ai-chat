 ...
 *   - `PublicConfig.layout.showFrame` / `openChatByDefault` / `injectCarbonTheme`
 *
...
// page — the chat's own `injectCarbonTheme` only themes its own subtree.
...
const config: PublicConfig = {
  ...
  // Pin the WHITE Carbon theme so the example renders consistently.
