...
- A mock `customSendMessage` that streams a response one word at a time using
  `addMessageChunk`.
...
- You want a full-width, inline chat container driven by your own transport
  function.
- You need a starting point for sending and receiving streaming messages with a
  mock backend.
