...
| [Mentions & Commands](./mentions-and-commands/README.md)                               | Demonstrates `@mentions` and `/commands` with structured data integration via `onSelect` and `updateStructuredData`.                           | `npm run start --workspace=@carbon/ai-chat-examples-web-components-mentions-and-commands`               |
| [Mentions & Commands (Custom Render)](./mentions-and-commands-custom-render/README.md) | Demonstrates custom token rendering for `@mentions` using Carbon Tag + Tooltip, with default chips for `/commands`.                            | `npm run start --workspace=@carbon/ai-chat-examples-web-components-mentions-and-commands-custom-render` |
| [Typeahead](./typeahead/README.md)                                                     | Demonstrates typeahead/autocomplete suggestions that appear as the user types.                                                                 | `npm run start --workspace=@carbon/ai-chat-examples-web-components-typeahead`                           |
| [Typeahead (Custom List)](./typeahead-custom/README.md)                                | Demonstrates a custom autocomplete list component via `renderCustomList`, replacing the built-in dropdown.                                     | `npm run start --workspace=@carbon/ai-chat-examples-web-components-typeahead-custom`                    |
| [Input Field Starter Prompts](./input-field-starter-prompts/README.md)                 | Demonstrates `SuggestionType.STARTER` — prompt seeds shown when the input is empty and focused.                                                | `npm run start --workspace=@carbon/ai-chat-examples-web-components-input-field-starter-prompts`         |
